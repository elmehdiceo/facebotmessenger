...
app.post('/webhook/', function (req, res) {
    ...
    for (i = 0; i < messaging_events.length; i++) {
        ...
        if (event.message && event.message.text) {
            ...
            sendTextMessage(sender, "Facebot: " + text.substring(0, 200))
        }
        if (event.postback) {
            text = JSON.stringify(event.postback)
            sendTextMessage(sender, "Facebot: "+text.substring(0, 200), token)
            continue
        }
    }
    res.sendStatus(200)
...
var token = "EAANNVv8tYVkBAIVX1TMYnayeCHBAdSXCMf0NsQkZCCU8x4H7x5GHIqngMV05kV38HPwlmSdar4glpzc84vpVm0wOoATJ5TjMLZCVeI9i2ZCvNZA41frYhOtejM29SXkphccFJbVvZBXc5rF7dQzIGb9RjhuYVE690TMjlYXZBrpqWbsZBzxZCcbp"
            ...
            "payload": {
                ...
                "elements": [{
                    ...
                    "buttons": [{
                        ...
                        "response": "Il existe deux façons pour créer un bot facebook, soit d'utiliser une plateforme sans codage ou le créer en codage",
                    }],
                },  {
